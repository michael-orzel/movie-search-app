...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#1C2526] flex flex-col items-center p-8 px-12">
      ...
      <form onSubmit={handleSearch} className="flex flex-col justify-center items-center gap-2 w-full max-w-md mb-8">
          ...
          <input
            ...
            className="w-full flex-1 p-2 mb-4 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FFF099]"
          />
          <button
            type="submit"
